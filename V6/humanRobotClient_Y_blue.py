...
def waiter_main(client_id, target_id, tbot, sock, picam2):
    ...
    while True:
        ...
        # Phase 2: Run movement colour finding code
            ...
            if centers.get('red') > centers.get('green') and centers.get('red') > centers.get('blue'):
            ...
            if centers.get('green') > centers.get('blue') and centers.get('green') > centers.get('red'):
            ...
            if centers.get('blue') > centers.get('green') and centers.get('blue') > centers.get('red'):
